...
/**
 * @description: （核心）手动加载默认数据源、创建数据源连接，检查数据源连接
 * @author: qsy
 * @create: 2020-06-20
 */
public class DynamicDataSource extends AbstractRoutingDataSource implements BaseDao {
    private boolean debug = true;
    private final Logger log = LoggerFactory.getLogger(getClass());
    private Map<Object, Object> dynamicTargetDataSources;
    private Object dynamicDefaultTargetDataSource;
    private  JdbcTemplate   qsyjdbcTemplate;
